...
class newKafkaTest extends AnyFlatSpec{
  ...
  "producerConsumer" should "have same dataframe" in{
    ...
    producerConsumer.producerCSV.prodcue(spark,"D:/TargetCoorporationPhaseSecond/latest/datastreaming_team1/testData.csv","kafka","localhost:9092","datastreamTest4")

    val outputDF = producerConsumer.newConsumerCSV.consume(spark,"kafka","localhost:9092","datastreamTest4")
